											...
											<div class="col-lg-6">
												<div class="form-group form-float">
													<select class="form-control show-tick" name="vid_pos" required="">
														...
														<?php
														for ($i=1; $i < 16; $i++)
															echo '<option value="English" '.(($i==$video['position']) ? 'selected' : '' ).'>'.$i.' Postion</option>';
														?>
													</select>
												</div>
											</div>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<button class="btn waves-effect bg-red waves-green js-sweetalert  m-r-20" data-datatype="dw_videos" data-dataname="<?= $video['title'];?> video" data-dataid="<?= $video['video_id']?>" data-type="cancel" data-colname="video_id" data-url="<?= base_url();?>"><i class="material-icons">delete_forever</i> Delete</button>
												<a href="<?= base_url('video/approvePendingVideo/'.$video['video_id'])?>" class="btn waves-effect bg-green waves-green m-r-20"><i class="material-icons">verified_user</i> Approve</a>
