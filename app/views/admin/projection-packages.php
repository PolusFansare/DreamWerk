...
if(!empty($edit))
{
	$package=$this->mysql->get_row("if_projection_package", "if_id = '$edit'");
	if(!$package)
		redirect("admin/projectionpackages");
?>
	<section class="content">
		<div class="container-fluid">
			<div class="block-header">
				<h2>Edit Profile Projection Package</h2>
			</div>
			<div class="block-header">
				<a href="<?= base_url()?>admin/projectionpackages" class="btn bg-green btn-xs waves-effect"><i class="material-icons">reply</i> Back</a>
			</div>
											...
											<div class="col-sm-5">
												<div class="form-group form-float">
													<div class="form-line">
														...
														<label class="form-label">Package Price (in $)</label>
													</div>
												</div>
											</div>
											<div class="col-sm-10">
					...
					<div class="card">
						...
						<div class="body table-responsive">
							<table class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<?php
									$packages=$this->mysql->get_data('if_projection_package', '');
									if($packages)
									...
									<tr>
										...
										<td>₨ <?=$package['if_price']?></td>
										<td>
											<a href="<?= base_url()?>admin/projectionpackages/edit/<?= $package['if_id']?>/<?=$package['if_package_name']?>" class="btn bg-green waves-effect waves-green"><i class="material-icons">mode_edit</i> Edit</a>
										</td>
									</tr>
									<?php
										}
